...
// for and while loops
/*
let enter = Number(prompt('lets play an game i m gone ask you questions and i need to guess an number between 1---10'))


for(let i = 0;i<=10;i++){
   let c1 = confirm('is your number between 1--5')

   if(c1===true){
      let c2 = confirm('is your number between 1--3')
      if(c2===true){
        let guess = confirm('is your number 2? ')
         if(guess===true){
                alert('i won')
         } 
      }
         ...
         if(c1===false){
         let c3 =confirm('is your number between 10--5')

         if(c3===true){
         let c4 =   confirm('is your number between 10---7')

         if(c4===true){
         let c5 =   confirm('is your number between 10---8')
            if(c5===true){
             let guess1 =  alert('is your number 9')
...
let me = new user('sandro','sidamonidze',11,'Giorgian','blue','burger and hotdog','lamborgini','java','it step')
...
// first homework
/*
let array = ['gio','sidamonidze',12,'USA','blue','pizza','lamborgini','java','it step']
